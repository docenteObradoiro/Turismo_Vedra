...
class Aceite : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var galeo=findViewById<ImageButton>(R.id.galeo)
        galeo.setOnClickListener {
            startActivity(Intent(Intent.ACTION_VIEW, Uri.parse("https://www.facebook.com/AceiteGaleo/")))
        }
